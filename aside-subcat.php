	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-cat _1">
							...
							<h2 class="sidebar-title"><span>Browse By:</span> Category</h2>

							<ul class="nav-cat ">
                                                              <?php
                                                                $menusql= mysql_query("select * from categories order by category_name");
                                                                while($menurows=mysql_fetch_array($menusql))
                                                                {
                                                                    $menuid=$menurows['id'];
                                                                    $menupr=mysql_query("select count(*) as count from products where category='$menuid' and subcategory = '$subid'");
								...
								<li>
									...
									<div class="check-box">
                                                                          <input type="hidden" name="subcathid" value="<?=$_GET['subcatid'];?>">
                                                                            <input type="checkbox" class="checkbox" id="cat-cat<?=$menurows['id'];?>" value="<?=$menurows['id'];?>" name="menuname[]">

										<label for="cat-cat<?=$menurows['id'];?>"><?=$menurows['category_name'];?>  <span>(<?=$menupnum['count'];?>)</span></label>
						...
						<aside class="sidebar sidebar-fac _1">
							...
							<ul class="nav-cat ">
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where brand='$brid' and subcategory = '$subid'");
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where color='$brid' and subcategory = '$subid'");
                                                                    $pnum=mysql_fetch_assoc($bpr);
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from products where age in ($ageid) and subcategory = '$subid' ");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from products where gender='3' and subcategory = '$subid' ");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from products where gender='1' and subcategory = '$subid' ");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from products where gender='2' and subcategory = '$subid' ");
