	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-cat _1">
							...
							<ul class="nav-cat ">
                                                              <?php
                                                                ...
                                                                {
                                                                    $menuid=$menurows['id'];
                                                                    $menupr=mysql_query("select count(*) as count from products where menu='$menuid' and collection_type ='$id' ");
						...
						<aside class="sidebar sidebar-fac _1">
							...
							<ul class="nav-cat ">
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where brand='$brid' and collection_type ='$id' ");
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where color='$brid' and collection_type ='$id'");
                                                                    $pnum=mysql_fetch_assoc($bpr);
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from products where age in ($ageid) and collection_type ='$id' ");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from products where gender='3' and collection_type ='$id' ");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from products where gender='1' and collection_type ='$id'");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from products where gender='2' and collection_type ='$id'");
