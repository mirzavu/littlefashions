	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-cat _1">
							...
							<h2 class="sidebar-title"><span>Browse By:</span> Menu</h2>
							...
							<ul class="nav-cat ">
                                                              <?php
                                                                ...
                                                                {
                                                                    $menuid=$menurows['id'];
                                                                    $menupr=mysql_query("select count(*) as count from products where `brand` = '$bridndname' and  menu='$menuid'");
								...
								<li>
									...
									<div class="check-box">
                                                                            <input type="hidden" name="barndnamehid" value="<?=$bridndname?>">
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where color='$brid' and `brand` = '$bridndname'");
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from products where age in ($ageid) and `brand` = '$bridndname'");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from products where gender='3' and `brand` = '$bridndname'");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from products where gender='1' and `brand` = '$bridndname'");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from products where gender='2' and `brand` = '$bridndname' ");
