        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-8 col-sm-8">
					...
					function renderForm($id, $category, $subcategory, $menu, $brand, $color, $age, $price, $gender, $product_name, $quantity, $description, $brandinf,$loyality,$offer,$product_id,$collection_type,$offer_type,$trending_type,$toprated_type,$error)
					{
						if ($error != '')
						{
      ...
      <div class="modal-body">
              ...
              <div class="form-group col-lg-4 col-sm-4 text-right top10">
                            <div class="btn-group btns-cart">
                                <input type="text" name="pids" value="<?=$imgid;?>">
						...
						if (isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0)
						 {
							...
							if($row)
							{
								...
								renderForm($id,$category, $subcategory, $menu, $brand, $color, $age, $price, $gender, $product_name, $quantity, $description, $brandinf,$loyality,$offer,$product_id,$collection_type,$offer_type,$trending_type,$toprated_type, '');
							}
							else
							{
								echo "No results!";
