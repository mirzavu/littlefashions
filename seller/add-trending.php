        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12">
                        <span class="title">Add Trading Product</span>
                </div>
                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO products (uid,product_id, category, subcategory, menu, brand, color, age, price, offerprice, gender, product_name, quantity, description, brandinf,trending_type,loyalitycash,flag) VALUES ('$uid','$product_id', '$category', '$subcategory', '$menu', '$brand', '$color', '$age', '$price',  '$offerprice','$gender', '$product_name', '$quantity', '$description', '$brandinf',11,'$loyalitycash',1)");
