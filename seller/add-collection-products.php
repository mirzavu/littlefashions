        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12">
                        <span class="title">Add Collection  Product</span>
                </div>
                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$loyalitycash = $_POST['loyalitycash'];
							$gender = $_POST['gender'];
							...
							$sql = mysql_query("INSERT INTO products (uid,product_id, category, subcategory, menu, brand, color, age, price, offerprice, gender, product_name, quantity, description, brandinf,collection_type,loyalitycash,flag) VALUES ('$uid','$product_id', '$category', '$subcategory', '$menu', '$brand', '$color', '$age', '$price',  '$offerprice','$gender', '$product_name', '$quantity', '$description', '$brandinf','$colltype','$loyalitycash',1)");
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='view-collections.php'</script>";
								exit();	
                    ...
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="col-lg-10 col-sm-10 top10">
                            ...
                            <select name="collections" class="form-control">
                                ...
                                <option value="1">Infant Collections</option>
                                <option value="2">Toddlers Collections </option>
                                <option value="3">Baby Accessories</option>
                                <option value="4">Tu Tu Collections</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-10 col-sm-10 top10">
                            ...
                            <div class="col-lg-8 col-sm-8"><input type="text" name="loyalitycash" class="form-control"></div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-lg-10 col-sm-10 top10">
