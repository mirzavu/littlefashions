...
<!-- Mirrored from envato.megadrupal.com/html/orenmode/product-detail-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 May 2015 06:02:23 GMT -->
		...
		<section class="product-detail _1 ">
			...
			<div class="container">
				...
				<div class="row">
                        ...
                        $sql = mysql_query("select * from collection_products where id = '$id' ");
                            ...
                            <ul id="etalage">
                                ...
                                <li>
                                    ...
                                    <a href="#">
                                        ...
                                        <img class="etalage_thumb_image" src="<?=$row_products['image']; ?>" />

                                        <img class="etalage_source_image" src="<?=$row_products['image']; ?>"/>
...
<!-- Mirrored from envato.megadrupal.com/html/orenmode/product-detail-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 May 2015 06:02:37 GMT -->
