...
session_start();
	...
	print_r($_SESSION['cart'][1]['product_id']);
    	if(isset($_GET['prd_cmp']))
{
		...
		<section class="breakcrumb bg-grey">
			<div class="container">
				...
				<ul class="nav-breakcrumb ">
					...
					<li><span>Product Compare</span></li>
				</ul>
			...
			<div class="container">
				<disv class="row">
					...
					<div id="portfolio" class="portfolio-cn _1 clearfix"  data-theme="3">
						<?php
                                $sql = mysql_query("select * from products WHERE flag = '1'and id in($asd) ORDER BY id DESC");
		                                  ...
		                                  <div class="col-md-6">
											...
											<div class="col-md-6">
		                                  	<p class="old-price"> 
                                               ...
                                               <div class="col-md-12">
                                                   <h2 class="name">Category:<?=get_category_name($row_products['category'])?></h2>
		
	
                                            </div>  
                                             <div class="col-md-12">
                                          	<h2 class="name">Brand:&nbsp;<?=get_brand_name($row_products['brand'])?></h2>
		
	
                                            </div>                         
                                             <div class="col-md-12">
                                          	<h2 class="name">Color:&nbsp;<?=get_color_name($row_products['color'])?></h2>
		
	
                                            </div>  
                                                                    
                                                  <div class="col-md-12">
                                          	<h2 class="name">Age:&nbsp;<?= get_age1($row_products['age'])?></h2>
