	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-fac _1">
							...
							<ul class="nav-cat ">
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and  brand='$brid'");
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and  color='$brid'");
                                                                    $pnum=mysql_fetch_assoc($bpr);
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and age in ($ageid) ");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and gender='3' ");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and gender='1' ");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from  products WHERE  trending_type ='11' and flag = '1' and gender='2' ");
