 ...
 * https://hybridauth.sourceforge.net/userguide/IDProvider_info_MySpace.html
...

{
	...
	*/
...

	{
		...
		$this->api->api_endpoint_url  = "https://api.myspace.com/v1/";

		$this->api->authorize_url     = "https://api.myspace.com/authorize";

		$this->api->request_token_url = "https://api.myspace.com/request_token";

		$this->api->access_token_url  = "https://api.myspace.com/access_token";
	...
	*/
...

	{
		...
		$response = $this->api->get( 'https://api.myspace.com/v1/user.json' );
	...
	*/
...

	{
		...
		$data = $this->api->get( 'https://api.myspace.com/v1/users/' . $userId . '/profile.json' );
	...
	*/
...

	{
		...
		$response = $this->api->get( "https://api.myspace.com/v1/users/" . $userId . "/friends.json" );
	...
	*/
	...
	// crappy myspace... gonna see this asaic
		...
		$response = $this->api->api( "https://api.myspace.com/v1/users/" . $userId . "/status", 'PUT', $parameters ); 
	...
	*/
...

	{
		...
		if( $stream == "me" ){
			...
			$response = $this->api->get( "https://api.myspace.com/v1/users/" . $userId . "/status.json" ); 

		}                                                          

		else{                                                      

			$response = $this->api->get( "https://api.myspace.com/v1/users/" . $userId . "/friends/status.json" );
