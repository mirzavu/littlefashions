	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-cat _1">
							...
							<ul class="nav-cat ">
                                                              <?php
                                                                $menusql= mysql_query("select * from menu where  subcat_name NOT IN('3','4','6') order by menu_name");
                                                                while($menurows=mysql_fetch_array($menusql))
                                                                {
                                                                    $menuid=$menurows['id'];
                                                                    $menupr=mysql_query("select count(*) as count from products where menu='$menuid' and banner_type='$bannerid' ");
								...
								<li>
									...
									<div class="check-box">
                                                                            <input type="hidden" name="bannerhid" value="<?=$bannerid?>">
						...
						<aside class="sidebar sidebar-fac _1">
							...
							<ul class="nav-cat ">
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where brand='$brid' and banner_type='$bannerid'");
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where color='$brid' and banner_type='$bannerid'");
                                                                    $pnum=mysql_fetch_assoc($bpr);
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from products where age in ($ageid) and banner_type='$bannerid' ");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from products where gender='3' and banner_type='$bannerid' ");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from products where gender='1' and banner_type='$bannerid'");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from products where gender='2' and banner_type='$bannerid' ");
