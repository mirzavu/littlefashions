		...
		<section class="breakcrumb bg-grey">
			<div class="container">
				...
				<ul class="nav-breakcrumb ">
					...
					<li><span><?php echo get_brand_name($bridndname) ;?></span></li>
				</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div id="portfolio" class="portfolio-cn _1 clearfix"  data-theme="3">
						<?php
                                $sql = mysql_query("SELECT * FROM products WHERE `brand` = '$bridndname' AND flag = '1'ORDER BY id DESC LIMIT 0 , 12");
