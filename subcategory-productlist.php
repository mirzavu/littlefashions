		...
		<section class="breakcrumb bg-grey">
			<div class="container">
				...
				<ul class="nav-breakcrumb ">
					...
					<li><span><?php echo get_sub_category_name($subid) ; ?></span></li>
				</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div id="portfolio" class="portfolio-cn _1 clearfix"  data-theme="3">
						<?php
                                $sql = mysql_query("select * from products WHERE subcategory ='$subid' and flag = '1'  ORDER BY id DESC  Limit 0,12 ");
