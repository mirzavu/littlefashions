			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-9">
						...
						if (isset($_GET['id']) && is_numeric($_GET['id']))
						 {
							...
							$row_orders = mysql_fetch_array($sql_orders);
									...
									$phone = $row_orders['phone'];
                                                                        ...
                                                                        $formatedorder_id=$row_orders['order_itemcode'];
                                                                    
                                                                          $addressuser=$row_orders['address'];
                                                                          
                                                                          $invoiceformat="LFIN".$txnid;
                        ...
                        Invoice No: <? echo $invoiceformat; ?><br />              
                        Phone: <? echo $phone ; ?><br />
                        Email: <? echo $email ; ?><br />
                       Address: <? echo $addressuser ; ?>
                        </p>
