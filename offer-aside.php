	<div class="col-md-3">
						...
						<aside class="sidebar sidebar-cat _1">
							...
							<ul class="nav-cat ">
                                                              <?php
                                                                ...
                                                                {
                                                                    $menuid=$menurows['id'];
                                                                    $menupr=mysql_query("select count(*) as count from products where menu='$menuid' and offers_type = '$offerid' ");
								...
								<li>
									...
									<div class="check-box">
                                                                            <input type="hidden" name="offershid" value="<?=$offerid?>">
						...
						<aside class="sidebar sidebar-fac _1">
							...
							<ul class="nav-cat ">
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where brand='$brid' and offers_type = '$offerid'");
						...
						<aside class="sidebar sidebar-color _1">
							...
							<ul class="nav-color"> 
                                                            <?php
                                                                ...
                                                                {
                                                                    $brid=$brows['id'];
                                                                    $bpr=mysql_query("select count(*) as count from products where color='$brid' and offers_type = '$offerid'");
                                                                    $pnum=mysql_fetch_assoc($bpr);
						...
						<aside class="sidebar sidebar-size _1">
							...
							<ul class="nav-cat ">
                                                             ...
                                                             <?php
                                                                ...
                                                                {
                                                                    $ageid=$arows['id'];
                                                                    $apr=mysql_query("select count(*) as count from products where age in ($ageid) and offers_type = '$offerid'");
						...
						<aside class="sidebar sidebar-tags  _1">
							...
							<ul class="nav-cat ">
								...
								<li>
                                                                      <?php
                                                                       $gendun=mysql_query("select count(*) as count from products where gender='3' and offers_type = '$offerid'");
								...
								<li>
                                                                    <?php
                                                                     $gendboy=mysql_query("select count(*) as count from products where gender='1' and offers_type = '$offerid'");
								...
								<li>
                                                                    <?php
                                                                     $gendgl=mysql_query("select count(*) as count from products where gender='2' and offers_type = '$offerid'");
