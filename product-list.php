		...
		<section class="breakcrumb bg-grey">
			<div class="container">
				...
				<ul class="nav-breakcrumb ">
					...
					<li><span><?php echo get_category_name($id) ; ?></span></li>
				</ul>
			...
			<div class="container">
				<div class="row">
					...
					<div id="portfolio" class="portfolio-cn _1 clearfix"  data-theme="3">
						<?php
                                $sql = mysql_query("select * from products WHERE category = '$id' and flag = '1'  ORDER BY id DESC  Limit 0,{$pg}");
						...
						<div class="col-md-4 col-lg-4" data-content="./product-description.php?id=<?=$row_products['id'];?>">
							<div class="portfolio-item _2">
								...
								<div class="text">
									...
									<h2 class="name">
										<a href="product-detail.php?id=<?=$row_products['id'];?>"><?=substr($row_products['product_name'],0,25);?>....</a>	
									</h2>	
...
<?
 ...
 $newpricess=$price - (($price*$row_products['offerprice'])/100);

echo round($newpricess,2);
?>


</span>&nbsp; <span class="price old-price">Rs. <? echo $price; ?></span> 
		                                  	       <? 
					...
					<div class="load-more-pf text-center text-uppercase">
                                                ...
                                                <?php
                                          $pagesddd=$_SERVER['REQUEST_URI'];
                                               ?>
						<a href="<?=$pagesddd?>&pg=<?=$pg ;?>" class="btn btn-9">Load More</a>
					</div>
