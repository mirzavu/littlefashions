			...
			<div class="container">
				<div class="row">
					...
					<div id="portfolio" class="portfolio-cn _1 clearfix"  data-theme="3">
						<?php
                                $sql = mysql_query("select * from products WHERE  collection_type ='$id' and flag = '1'  ORDER BY id DESC  Limit 0,12 ");
