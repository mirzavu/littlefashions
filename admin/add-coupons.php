                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO coupons (coupon_type,category,brand,coupon, percentage, flag) VALUES ('$coutype','$category','$brands','$coupon', '$percentage', '0')");
                	...
                	<form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <label for="category-name">Coupon Type</label><br>
                            <select name="coutype" id="coutype" onChange="showHint(this.value)" class="form-control">
                            <option value="1">Universal Coupon</option>
                            <option value="2">Coupon By Brand</option>
                            <option value="3">Coupon By Category</option>
