                	...
                	<?php 
						...
						else
						{
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-toprated.php'</script>";
								exit();	
