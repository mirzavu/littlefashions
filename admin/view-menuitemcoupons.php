        	...
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12 text-center">
                	...
                	<table class="table table-bordered tbl-cart">
                        ...
                        <tbody>
                        <?php
							$sql_brands = mysql_query("SELECT * FROM coupons where coupon_type='Menu Items coupon'");
						...
						?>
                                <tr>
                                    ...
                                    <td>
                                    <?php
                                    $categ=$row_brands['category'];
                                    $sel=  mysql_query("select * from categories where id='$categ'");
                                    $rowcateg=  mysql_fetch_assoc($sel);
                                    echo $rowcateg['category_name'];
                                    ...
                                    <td>
                                    <?php
                                    $subcateg=$row_brands['sub_category'];
                                    $sel=  mysql_query("select * from sub_categories where id='$subcateg'");
                                    $rowcateg=  mysql_fetch_assoc($sel);
                                    echo $rowcateg['subcat_name'];
                                    
                                    ?>
                                        
                                    
                                    </td>
                                     <td><?=$row_brands['coupon_type'];?></td>
