        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12">
                        <span class="title">Add Offer Products</span>
                </div>
                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO products (product_id, category, subcategory, menu, brand, color, age, price, offerprice, gender, product_name, quantity, description, brandinf,offers_type, flag) VALUES ('$product_id', '$category', '$subcategory', '$menu', '$brand', '$color', '$age', '$price',  '$offerprice','$gender', '$product_name', '$quantity', '$description', '$brandinf','$offerid',1)");
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-offer-products.php'</script>";
								exit();	
                    ...
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                         ...
                         <div class="col-lg-10 col-sm-10 top10">
							...
							<select  onChange="getOffer(this.value);"  name="offerid" class="form-control">
								...
								while($rowoffr=mysql_fetch_array($sqlof)){
									?>
									<option value="<?php echo $rowoffr['id']?>"><?php echo $rowoffr['offer_name']?></option>
									<?php
								}
								?>
							</select>
                        ...
                        <div class="col-lg-10 col-sm-10 top10">
                            ...
                            <div class="col-lg-8 col-sm-8"><input type="text" name="offerprice" class="form-control" id="offervals" readonly="readonly"></div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-lg-10 col-sm-10 top10">
