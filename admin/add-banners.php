                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO banners (banner_name, image, flag) VALUES ('$banner_name', '$img_loc', 1)");
							...
							{
								echo '<script language=javascript>alert("Brand Added..")</script>';
								echo "<script type='text/javascript'>window.location='add-banners.php'</script>";
								exit();					
							}
						}
					?>
