        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12">
                       <span class="title">Add Collections</span><a href="view-collections-banners.php" class="pull-right">View Collection Banners</a>
                </div>
                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO collections (type, banner_name, image, flag) VALUES ('$type', '$banner_name', '$img_loc', 1)");
							...
							{
								echo '<script language=javascript>alert("Collection Added..")</script>';
								echo "<script type='text/javascript'>window.location='add-collections.php'</script>";
								exit();					
							}
						}
					?>
                	...
                	<form action="#" method="post" enctype="multipart/form-data">
                        <div class="col-lg-10 col-sm-10">
                            ...
                            <label for="banner-name">Type Of Collection</label>
