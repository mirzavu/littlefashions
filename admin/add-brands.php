                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO brands (brand_name, image, flag) VALUES ('$brand_name', '$img_loc', 1)");
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-brands.php'</script>";
								exit();					
							}
						}
					?>
