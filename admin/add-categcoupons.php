                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO coupons (coupon_type,category,times_apply,coupon, percentage,my_choice) VALUES ('$text','$brandcoutype','$timesapply','$coupon', '$percentage','c')");
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-categcoupons.php'</script>";
								exit();					
							}
						}
					?>
