                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO colors (color, flag) VALUES ('$color', 1)");
							...
							{
								echo '<script language=javascript>alert("Color Added..")</script>';
								echo "<script type='text/javascript'>window.location='add-colors.php'</script>";
								exit();					
							}
						}
					?>
