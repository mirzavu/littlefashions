        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-12 col-sm-12">
                        <span class="title">View Collections</span>
                </div>
                ...
                <div class="col-lg-12 col-sm-12 text-center">
                	<table class="table table-bordered tbl-cart table-responsive">
                        ...
                        <tbody>
                        <?php
							$sql_Products = mysql_query("SELECT * FROM collection_products");
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                    	 <? 
											...
											{
										?>
                                        		<a href="enable-collections.php?id=<?=$row_products['id'];?>" onclick="return confirm('Confirm to Enable?');">
                                        ...
                                        <?
											...
											{
										?>
                                        		<a href="disable-collections.php?id=<?=$row_products['id'];?>" onclick="return confirm('Confirm to Disable?');">
                                                    <i class="fa fa-trash-o"></i>
                                                </a>
                                        <?
											}
										?>
                                        <a href="edit-collections.php?id=<?=$row_products['id'];?>">
                                            <i class="fa fa-edit"></i>
                                        </a> &nbsp;
                                        
                                        <a href="delete-collections.php?id=<?=$row_products['id'];?>" onclick="return confirm('Confirm to delete?');">
                                            ...
                                            <div class="modal-body">
                                           		<div class="container-fluid">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-7"><?=$collection;?></div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                      ...
                                                      <div class="col-md-1">:</div>
                                                      <div class="col-md-7"><img src="../<?=$row_products['image'];?>" width="100" height="100"></div>
                                                    </div>
                                                    <div class="row">
