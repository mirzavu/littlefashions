    ...
    <div class="container main-container">
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO products (product_id, category, subcategory, menu, brand, color, age, price, offerprice, gender, product_name, quantity, description, brandinf,banner_type,loyalitycash,flag) VALUES ('$product_id', '$category', '$subcategory', '$menu', '$brand', '$color', '$age', '$price',  '$offerprice','$gender', '$product_name', '$quantity', '$description', '$brandinf','$bannertype','$loyalitycash',1)");
				...
				echo "<script type='text/javascript'>window.location='add-bannerproduct.php'</script>";
								exit();	
