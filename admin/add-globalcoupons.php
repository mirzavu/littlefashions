                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO coupons (coupon_type,category,times_apply,coupon, percentage, flag) VALUES ('$text','$global','$timesapply','$coupon', '$percentage', '0')");
                	...
                	<form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <label for="category-name"> Global Coupon Name </label><br>
                            <input type="text" name="global" value='global' readonly="readonly" id="global">                    
