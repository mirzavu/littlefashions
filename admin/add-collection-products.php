                	...
                	<?php 
						...
						else
						{
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-collection-products.php'</script>";
								exit();	
