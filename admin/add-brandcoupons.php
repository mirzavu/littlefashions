                ...
                <div class="col-lg-8 col-sm-8">
                	...
                	<?php 
						...
						else
						{
							...
							$sql = mysql_query("INSERT INTO coupons (coupon_type,brand,category,times_apply,coupon, percentage, flag) VALUES ('$text','$brandcoutype','$categtype','$timesapply','$coupon', '$percentage', '0')");
							...
							else
							{
								...
								echo "<script type='text/javascript'>window.location='add-brandcoupons.php'</script>";
								exit();					
							}
						}
					?>
                	...
                	<form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <label for="category-name">Brand Type</label><br>
                            <select name="brandcoutype" id="brandcoutype" class="form-control">
                           <?
                           get_brand();
                           ?>
                                          ...
                                          <div class="col-lg-6 col-sm-6 top10">
                            <label for="category-name">Category Type</label><br>
                            <select name="categtype" id="categtype" class="form-control">
                           <?
                          get_category()
                           ?>
                         ...
                         <div class="clearfix"></div>
                             <div class="col-lg-6 col-sm-6 top10">
                              <label for="category-name">Times Coupon</label><br>
                        <div id="getresult">
